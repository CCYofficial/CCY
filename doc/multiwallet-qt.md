...
In order to support loading of multiple wallets in cryptocurrency-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is cryptocurrency.cpp.
...
Changes to cryptocurrency.cpp
----------------------
cryptocurrency.cpp is the entry point into cryptocurrency-qt, and as such, will require some minor modifications to provide hooks for
