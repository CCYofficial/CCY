...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Cryptocurrency Core"),
     ...
     * override -datadir in the cryptocurrency.conf file in the default data directory
     * (to be consistent with cryptocurrencyd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
