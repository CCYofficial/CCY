                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Cryptocurrency") + " ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Cryptocurrency address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and cryptocurrency: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Cryptocurrency Core"), this);
    aboutAction->setStatusTip(tr("Show information about Cryptocurrency Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Cryptocurrency"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Cryptocurrency addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Cryptocurrency addresses"));
    ...
    openAction->setStatusTip(tr("Open a Cryptocurrency: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Cryptocurrency Core help message to get a list with possible Cryptocurrency command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Cryptocurrency Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Cryptocurrency network", "", count));
}
...
{
    QString strTitle = tr("Cryptocurrency Core"); // default title
    ...
    // Append title to "Cryptocurrency - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
