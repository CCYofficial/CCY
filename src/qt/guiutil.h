...
/** Utility functions used by the Cryptocurrency Qt UI.
 */
namespace GUIUtil
{
...
// Render Cryptocurrency addresses in monospace font
...
// Parse "cryptocurrency:" URI into recipient object, return true on successful parsing
