...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Cryptocurrency server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Cryptocurrency server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"blockchain", "getblockval", &getblockval, true, false, false},
        ...
        {"cryptocurrency", "masternode", &masternode, true, true, false},
        {"cryptocurrency", "listmasternodes", &listmasternodes, true, true, false},
        {"cryptocurrency", "getmasternodecount", &getmasternodecount, true, true, false},
        {"cryptocurrency", "masternodeconnect", &masternodeconnect, true, true, false},
        {"cryptocurrency", "masternodecurrent", &masternodecurrent, true, true, false},
        {"cryptocurrency", "masternodedebug", &masternodedebug, true, true, false},
        {"cryptocurrency", "startmasternode", &startmasternode, true, true, false},
        {"cryptocurrency", "createmasternodekey", &createmasternodekey, true, true, false},
        {"cryptocurrency", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"cryptocurrency", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"cryptocurrency", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"cryptocurrency", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"cryptocurrency", "getmasternodescores", &getmasternodescores, true, true, false},
        {"cryptocurrency", "mnbudget", &mnbudget, true, true, false},
        {"cryptocurrency", "preparebudget", &preparebudget, true, true, false},
        {"cryptocurrency", "submitbudget", &submitbudget, true, true, false},
        {"cryptocurrency", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"cryptocurrency", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"cryptocurrency", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"cryptocurrency", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"cryptocurrency", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"cryptocurrency", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"cryptocurrency", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"cryptocurrency", "checkbudgets", &checkbudgets, true, true, false},
        {"cryptocurrency", "mnsync", &mnsync, true, true, false},
        {"cryptocurrency", "spork", &spork, true, true, false},
        {"cryptocurrency", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"cryptocurrency", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use cryptocurrencyd, or the -server option to cryptocurrency-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> cryptocurrency-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:5536/\n";
}
