/* src/config/cryptocurrency-config.h.  Generated from cryptocurrency-config.h.in by configure.  */
/* src/config/cryptocurrency-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "cryptocurrencycrypto.io"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Cryptocurrency"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Cryptocurrency 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "cryptocurrency"
