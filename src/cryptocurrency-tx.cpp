...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Cryptocurrency Core cryptocurrency-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  cryptocurrency-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded cryptocurrency transaction") + "\n" +
                               "  cryptocurrency-tx [options] -create [commands]   " + _("Create hex-encoded cryptocurrency transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded cryptocurrency transaction
